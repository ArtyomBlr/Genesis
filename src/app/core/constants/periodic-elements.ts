...
export const ELEMENT_DATA: PeriodicElement[] = [
  ...
  {position: 32, name: 'Neon', weight: 20.1797, symbol: 'Ne'},
  {position: 33, name: 'Neon', weight: 20.1797, symbol: 'Ne'},
  {position: 34, name: 'Neon', weight: 20.1797, symbol: 'Ne'},
  {position: 35, name: 'Neon', weight: 20.1797, symbol: 'Ne'},
  {position: 36, name: 'Neon', weight: 20.1797, symbol: 'Ne'},
  {position: 37, name: 'Hydrogen', weight: 1.0079, symbol: 'H'},
  {position: 38, name: 'Helium', weight: 4.0026, symbol: 'He'},
  {position: 39, name: 'Lithium', weight: 6.941, symbol: 'Li'},
